...
transformer分为编码器和解码器，编码器的输入是4X5的  我爱中国 。解码器的输出输入是4X5的信息编码矩阵memory以及start I love China end 。解码器的输出是4X5000，或者说是四个词，这四个单词和ground truth：I love china end 做对比，越接近越好。剩下的是损失函数的事情

**注：以上为训练过程，推理过程需要增添掩码机制**
